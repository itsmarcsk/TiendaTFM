...
app = FastAPI(title="Mini API de almacenamiento")
...
async def download_video(filename: str):
    ...
    # Devuelve el archivo como StreamingResponse
    return StreamingResponse(
        video_stream,
        media_type=get_video_content_type(filename),
        headers={"Content-Disposition": f"attachment; filename={filename}"}  # Cambiado a 'inline' para mostrar el video
    )
